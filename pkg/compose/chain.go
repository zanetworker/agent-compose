...
func (c *ChainedHarnessResolver) Resolve(ctx context.Context, name string) (*HarnessProfile, error) {
...
func (c *ChainedHarnessResolver) List(ctx context.Context) ([]HarnessProfile, error) {
	seen := make(map[string]bool)
	var all []HarnessProfile
	for _, r := range c.resolvers {
